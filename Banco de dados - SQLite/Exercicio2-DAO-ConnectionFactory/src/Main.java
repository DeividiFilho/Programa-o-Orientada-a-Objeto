...
public class Main {
    public static void main(String[] args) {
        ...
        Cargo cargo2 = new Cargo(20, "Governante");

        CargoDAO cargoDAO = new CargoSQliteDAO();
        cargoDAO.salvar(cargo1);
        cargoDAO.salvar(cargo2);

        Candidato candidato1 = new Candidato(99762, "Júlia", cargo1, partido1);
        Candidato candidato2 = new Candidato(5262, "Deividi", cargo2, partido2);
